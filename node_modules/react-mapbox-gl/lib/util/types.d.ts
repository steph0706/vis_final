...
import { VectorSource, RasterSource, GeoJSONSource, GeoJSONSourceRaw, Point, Map } from 'mapbox-gl';
...
export declare type Sources = VectorSource | RasterSource | GeoJSONSource | GeoJSONSourceRaw;
